 ...
 * @category Encryption
 */
export declare function aesGcmEncrypt<T extends string | Uint8Array>(content: T, password: string | Uint8Array, prefix?: string | Uint8Array, ivLen?: number): Promise<T>;
/**
 ...
 * @category Encryption
 */
export declare function aesGcmDecrypt<T extends string | Uint8Array>(ciphertext: T, password: string | Uint8Array, ivLen?: number): Promise<T>;
