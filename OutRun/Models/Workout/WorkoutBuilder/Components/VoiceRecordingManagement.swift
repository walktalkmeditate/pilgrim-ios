...
public class VoiceRecordingManagement: NSObject, WorkoutBuilderComponent {
    ...
    public func bind(builder: WorkoutBuilder) {
        ...
        builder.statusPublisher
            ...
            .sink { [weak self] status in
                ...
                self.isWorkoutActive = status.isActiveStatus
    ...
    public func startRecording() {
        guard isWorkoutActive, !isRecording else { return }
