...
final class TranscriptionService: ObservableObject {
    ...
    func transcribeRecordings(_ recordings: [ORVoiceRecordingInterface]) async -> [UUID: String] {
    ...
    func transcribeSingle(_ recording: ORVoiceRecordingInterface) async -> String? {
