...
extension DataStack {
    ...
    /**
     Initialises a `DataStack` from a chain of `DataModelProtocol.Type`s and an optional current version model
     - parameter oRMigrationChain: an array of `DataModelProtocol.Type`s providing the migration chain
     - parameter oRDataModel: an `DataModelProtocol.Type` providing the current data model version
     */
    convenience init(oRMigrationChain: [DataModelProtocol.Type], oRDataModel: DataModelProtocol.Type? = nil) {
