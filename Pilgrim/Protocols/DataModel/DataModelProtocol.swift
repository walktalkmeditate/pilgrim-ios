...
protocol DataModelProtocol {
    ...
    static var migrationChain: [DataModelProtocol.Type] { get }
...
extension DataModelProtocol {
     ...
     */
    static func containsAllElements(of otherModel: DataModelProtocol.Type) -> Bool {
     ...
     */
    static func isSuccessor(to otherModel: DataModelProtocol.Type) -> Bool {
        if !(self.containsAllElements(of: otherModel) || otherModel.containsAllElements(of: self)) {
            fatalError("[DataModelProtocol] Tried to determine successor of incompatible DataModelProtocols")
        }
