...
public protocol EventInterface: DataInterface {
    ...
    /// The first `startDate` of the `Walk`s associated with this event.
    var startDate: Date? { get }
    /// The last `endDate` of the `Walk`s associated with this event.
    var endDate: Date? { get }
    /// A reference to the `Walk`s associated with this event.
    var workouts: [WalkInterface] { get }
    
}

public extension EventInterface {
    ...
    var workouts: [WalkInterface] { throwOnAccess() }
