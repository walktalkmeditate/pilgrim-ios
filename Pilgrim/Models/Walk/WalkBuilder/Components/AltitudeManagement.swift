...
/// A `WalkBuilderComponent` for measuring changes in altitude and recording them for the refinement of route data
public class AltitudeManagement: WalkBuilderComponent {
