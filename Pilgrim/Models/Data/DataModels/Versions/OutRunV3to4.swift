...
enum OutRunV3to4: DataModelProtocol, IntermediateDataModelProtocol {
    ...
    static let schema = CoreStoreSchema(
        ...
        versionLock: OutRunV3to4.versionLock
    )
    ...
    static let migrationChain: [DataModelProtocol.Type] = [OutRunV1.self, OutRunV2.self, OutRunV3.self, OutRunV3to4.self]
    static let intermediateMappingActions: IntermediateMappingActions = { dataStack in
