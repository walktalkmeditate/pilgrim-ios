...
enum OutRunV3: DataModelProtocol {
    ...
    static let schema = CoreStoreSchema(
        ...
        versionLock: OutRunV3.versionLock
    )
    ...
    static let migrationChain: [DataModelProtocol.Type] = [OutRunV1.self, OutRunV2.self, OutRunV3.self]
