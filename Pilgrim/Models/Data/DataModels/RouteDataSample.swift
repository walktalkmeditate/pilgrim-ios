...
public typealias RouteDataSample = PilgrimV6.WorkoutRouteDataSample

// MARK: - CustomStringConvertible

extension RouteDataSample: CustomStringConvertible {
...
// MARK: - RouteDataSampleInterface

extension RouteDataSample: RouteDataSampleInterface {
    ...
    public var workout: WalkInterface? { threadSafeSyncReturn { self._workout.value } }
    
}

// MARK: - TempValueConvertible

extension RouteDataSample: TempValueConvertible {
